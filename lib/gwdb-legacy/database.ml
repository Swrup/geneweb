...
let make_record_access _perm ic ic_acc shift array_pos (plenr, patches)
...
let opendb bname =
  ...
  in
  let persons =
    make_record_access perm ic ic_acc shift persons_array_pos patches.h_person
  ...
  let ascends =
    make_record_access perm ic ic_acc shift ascends_array_pos patches.h_ascend
  ...
  let shift = shift + (persons_len * Iovalue.sizeof_long) in
  let unions =
    make_record_access perm ic ic_acc shift unions_array_pos patches.h_union
  ...
  let shift = shift + (persons_len * Iovalue.sizeof_long) in
  let families =
    make_record_access perm ic ic_acc shift families_array_pos patches.h_family
  ...
  let couples =
    make_record_access perm ic ic_acc shift couples_array_pos patches.h_couple
  ...
  let shift = shift + (families_len * Iovalue.sizeof_long) in
  let descends =
    make_record_access perm ic ic_acc shift descends_array_pos patches.h_descend
  ...
  let shift = shift + (families_len * Iovalue.sizeof_long) in
  let strings =
    make_record_access perm ic ic_acc shift strings_array_pos patches.h_string
