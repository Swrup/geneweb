...
and compare_month strict failure success dmy1 dmy2 =
  match (dmy1.month, dmy2.month) with
...
and compare_day strict failure success dmy1 dmy2 =
  match (dmy1.day, dmy2.day) with
  | 0, 0 -> cmp_prec strict failure success dmy1 dmy2
  | 0, _ ->
      if dmy1.prec = After then success 1
      else if strict then failure ()
...
and cmp_prec strict failure success dmy1 dmy2 =
  ...
  | OrYear dmy1, OrYear dmy2 | YearInt dmy1, YearInt dmy2 ->
      compare_dmy_aux ~strict failure success (dmy_of_dmy2 dmy1)
        (dmy_of_dmy2 dmy2)
